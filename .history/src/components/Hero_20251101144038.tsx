                ...
                <div className="relative z-10 space-y-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4 pt-6">
                      <div className="text-center p-4 bg-gradient-to-br from-amber-50 to-white rounded-2xl border border-amber-100 hover:shadow-lg transition-all duration-300">
                        <ChefHat className="w-8 h-8 text-amber-600 mx-auto mb-2" />
                        <div className="text-sm font-semibold text-gray-800">Traditional</div>
                        <div className="text-xs text-gray-600">Recipes</div>
                      </div>
                      <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-white rounded-2xl border border-blue-100 hover:shadow-lg transition-all duration-300">
