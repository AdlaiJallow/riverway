          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            >
              <div className="grid sm:grid-cols-2 gap-4">
                <a
                  href="tel:+2203939528"
                  className="group relative px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-bold rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-2xl flex items-center justify-center gap-3 overflow-hidden text-sm sm:text-base no-underline"
                >
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6 lg:gap-8 mb-8">
              ...
              <div className="bg-gradient-to-br from-green-50 to-white p-6 rounded-2xl border border-green-100 hover:shadow-lg transition-all duration-300">
                ...
                <div className="space-y-2">
                  <a href="tel:+2203939528" className="block text-gray-900 font-semibold hover:text-green-600 transition-colors duration-200">+220 3939528</a>
                  <a href="tel:+2209957606" className="block text-gray-900 font-semibold hover:text-green-600 transition-colors duration-200">+220 9957606</a>
                </div>
              </div>
            </div>
