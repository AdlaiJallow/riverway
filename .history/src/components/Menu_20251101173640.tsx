      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="space-y-6">
            ...
            {/* Description */}
            <p className="text-lg sm:text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed font-light animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
        ...
        <div 
          ref={setRef('features')}
          className={`grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-8 mb-12 lg:mb-16 transition-all duration-1000 delay-300 ${
            isVisible.features 
              ? 'opacity-100 translate-y-0' 
              : 'opacity-0 translate-y-12'
          }`}
        ...
        >
          <div className="relative group max-w-5xl mx-auto">
            ...
            {/* Menu Card */}
            <div className="bg-gradient-to-br from-white via-amber-50 to-blue-50 rounded-3xl p-4 sm:p-6 lg:p-8 shadow-2xl border border-amber-200 group-hover:shadow-3xl transition-all duration-500">
              {/* Card Header */}
        ...
        >
          <div className="bg-gradient-to-r from-amber-600 to-blue-600 text-white rounded-3xl p-12 shadow-2xl">
            <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Ready to Experience Our Flavors?</h3>
            <p className="text-lg sm:text-xl opacity-90 mb-8 max-w-2xl mx-auto">
              Join us for an authentic culinary journey through The Gambia's finest dishes
            </p>
            <button 
              onClick={() => setCurrentPage('orders')}
              className="px-10 py-4 bg-white text-amber-700 font-bold text-lg rounded-xl hover:bg-amber-50 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl"
            >
              Order Now
            </button>
          </div>
