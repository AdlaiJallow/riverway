...
📅 Date: ${formattedDate}
🕒 Time: ${formattedTime}
👥 Party Size: ${reservationData.partySize} ${parseInt(reservationData.partySize) === 1 ? 'person' : 'people'}
💬 Special Requests: ${reservationData.specialRequests || 'None'}

NEXT STEPS:
1. Call the customer to confirm availability
2. Discuss any special dietary requirements or preferences
3. Confirm traditional Gambian dishes if requested
