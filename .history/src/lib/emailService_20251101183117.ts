...
export const sendReservationEmail = async (orderData: ReservationData, totalAmount: number, selectedItemsWithPrices: Array<{name: string, price: number}>): Promise<boolean> => {
